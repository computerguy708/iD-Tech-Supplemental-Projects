...
public class GlobAttack extends PApplet {
	...
	public void setup() {
		...
		for (int i = 1; i <= 6; i++) {
            playerAnim[i-1]=loadImage("Bat_Brains_" + i + ".png");
            playerAnim[i-1].resize(60, 0);
       }
		for (int j = 1; j <= 6; j++) {
            enemyAnimations[0][j - 1] = loadImage("Bat_Purple" + j + ".png");
            enemyAnimations[1][j - 1] = loadImage("Bat_Square" + j + ".png");
            enemyAnimations[2][j - 1] = loadImage("Bat_Booger" + j + ".png");
